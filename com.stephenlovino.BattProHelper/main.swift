...
let listener = NSXPCListener(machServiceName: "com.stephenlovino.BattProHelper.mach")
...
Timer.scheduledTimer(withTimeInterval: 10, repeats: true) { timer in
    ...
    for app in applications {
        if(app.bundleIdentifier?.elementsEqual("com.stephenlovino.BatteryPro") == true){
            foundApp = true
        }
    }
